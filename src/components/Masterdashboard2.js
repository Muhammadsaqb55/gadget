        ...
        <div className="content-o">
          <div className="container">
            <div className="dashboard-header text-center">
              <a href="index.html">
                <img src="assets/images/logo-trans.png" alt="logo" className="img-fluid" />
              </a>
            </div>
            ...
            <div className="row">
              ...
              >
                <h2 className="text-center">
                  <b>Individual Recyclers</b>
                </h2>
                <div className="row">
                  <div className="col-md-4 text-center pb-2 pt-2">
                    <div
                      className="inner-box1 p-3"
                      style={{ backgroundColor: '#FFEECD', borderRadius: '20px' }}
                    >
                      <h5>
                        <b>Total Orders</b>
                      </h5>
...
export default Masterdashboard2;