          ...
          <div className="form-inner">
            ...
            <div className="row">
              <div className="col-md-12" style={{ paddingLeft: '50px', paddingRight: '50px', borderRadius: '30px', padding: '10px 20px 20px 20px', alignContent: 'middle' }}>
                <h2 className="text-center"><b>All Recyclers</b></h2>
                <div className="row">
                  ...
                  <div className="col-md-4 text-center pb-2 pt-2">
                    <div className="inner-box1 p-3" style={{ backgroundColor: '#FFEECD', borderRadius: '20px' }}>
                      ...
                      <p><b>25</b></p>
                      <p><b><a href=""><u>Issue Details</u></a></b></p>
                    </div>
                  </div>
                  <div className="col-md-4 text-center pb-2 pt-2">
                    <div className="inner-box1 p-3" style={{ backgroundColor: '#FFEECD', borderRadius: '20px' }}>
                      <h5><b>Current Issues</b></h5>
                      <h3><b>Recycler Name</b></h3>
                      <p><b><a href=""><u>Issue Details</u></a></b></p>
                    </div>
                  </div>
                  <div className="col-md-4 text-center pb-2 pt-2">
                    <div className="inner-box1 p-3" style={{ backgroundColor: '#FFEECD', borderRadius: '20px' }}>
                      <h5><b>Live URL Status</b></h5>
                      <h3><b>Active</b></h3>
                      <p><b><a href=""><u>URL Status</u></a></b></p>
                    </div>
                  </div>
                  <div className="col-md-4 text-center pb-2 pt-2">
                    <div className="inner-box1 p-3" style={{ backgroundColor: '#FFEECD', borderRadius: '20px' }}>
                      <h5><b>PostBack Status</b></h5>
                      <h3><b>Active</b></h3>
                      <p><b><a href=""><u>PostBack Status Details</u></a></b></p>
                    </div>
                  </div>
                </div>
              </div>
